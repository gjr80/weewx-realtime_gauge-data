...
1.  Download the latest *Realtime gauge-data* extension from the *Realtime gauge-data* extension [releases page](https://github.com/gjr80/weewx-realtime_gauge-data/releases) into a directory accessible from the weeWX machine.
        ...
        wget -P $DOWNLOAD_ROOT https://github.com/gjr80/weewx-realtime_gauge-data/releases/download/v0.2.9/rtgd-0.2.9.tar.gz
...
3.  Install the *Realtime gauge-data* extension downloaded at step 1 using the *wee_extension* utility:
        ...
        wee_extension --install=$DOWNLOAD_ROOT/rtgd-0.2.9.tar.gz

    This will result in output similar to the following:

        Request to install '/var/tmp/rtgd-0.2.9.tar.gz'
        Extracting from tar archive /var/tmp/rtgd-0.2.9.tar.gz
        ...
        Finished installing extension '/var/tmp/rtgd-0.2.9.tar.gz'

...
/releases/download/v0.3.6/rtgd-0.3.6.tar.gz
...
wee_extension utility:
    ...
    This will result in output similar to the following:
        ...
        Request to install '/var/tmp/rtgd-0.3.6.tar.gz'
        Extracting from tar archive /var/tmp/rtgd-0.3.6.tar.gz

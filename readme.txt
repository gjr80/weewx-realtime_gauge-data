...
/releases/download/v0.2.2/rtgd-0.2.2.tar.gz
...
*wee_extension* utility:
    ...
    wee_extension --install=$DOWNLOAD_ROOT/rtgd-0.2.2.tar.gz

    This will result in output similar to the following:

        Request to install '/var/tmp/rtgd-0.2.2.tar.gz'
        Extracting from tar archive /var/tmp/rtgd-0.2.2.tar.gz
        ...
        Finished installing extension '/var/tmp/rtgd-0.2.2.tar.gz'
